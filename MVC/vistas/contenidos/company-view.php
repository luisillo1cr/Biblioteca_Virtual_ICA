...
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
		  ...
		  <h5><i class="zmdi zmdi-plus zmdi-hc-fw"></i> &nbsp; NUEVA EMPRESA</h5>
	  		</a>
	  	</li>
	  	<li>
		  <a href="<?php echo SERVERURL; ?>companylist/" class="btn btn-success">
		  <h5><i class="zmdi zmdi-format-list-bulleted zmdi-hc-fw"></i> &nbsp; LISTA DE EMPRESAS</h5>
	  		</a>
	  	</li>
	</ul>
</div>
...
<div class="container-fluid">
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> &nbsp; DATOS DE LA EMPRESA</h3>
		</div>
		<div class="panel-body">
			<form>
		    	<fieldset>
		    		<legend><i class="zmdi zmdi-assignment zmdi-hc-fw"></i> &nbsp; Datos básicos</legend>
		    		<div class="container-fluid">
		    			<div class="row">
			    ...
			    <p class="text-center" style="margin-top: 20px;">
			    	<button type="submit" class="btn btn-info btn-raised btn-sm"><h5> <i class="zmdi zmdi-floppy zmdi-hc-lg"></i> GUARDAR </h5></button>
			    </p>
		    </form>
		</div>
	</div>
